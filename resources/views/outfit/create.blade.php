                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('outfit.store') }}">
                            ...
                            <div class="form-group">
                                <label>Type:</label>
                                <input placeholder="Enter outfit type" type="text" name="outfit_type" class="form-control"
                                    value="{{ old('outfit_type') }}">
                            </div>

                            <div class="form-group">
                                <label>Color:</label>
                                <input placeholder="Enter outfit color" type="text" name="outfit_color" class="form-control"
                                    value="{{ old('outfit_color') }}">
                            </div>

                            <div class="form-group">
                                <label>Size:</label>
                                <input placeholder="Enter outfit size" type="text" name="outfit_size" class="form-control"
                                    value="{{ old('outfit_size') }}">
                            </div>
